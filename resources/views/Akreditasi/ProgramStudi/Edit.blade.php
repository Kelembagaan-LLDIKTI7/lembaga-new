...
@section('content')
    <div class="container-fluid">
        <a href="{{ route('program-studi.show', ['id' => $akreditasi->id_prodi]) }}"><i
                class="fas fa-arrow-left mb-4 me-2"></i> Kembali
            <div class="row">
                <div class="col-12">
                    <form id="formAkreditasiProdiEdit"
                        action="{{ route('akreditasi-program-studi.update', $akreditasi->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT') <!-- Menggunakan metode PUT untuk update -->
                        <input type="hidden" name="id_prodi" value="{{ $akreditasi->id_prodi }}" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <small class="text-danger error-message"
                                                id="error-id_peringkat_akreditasi"></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            @enderror
                                            <small class="text-danger error-message"
                                                id="error-akreditasi_tgl_akhir"></small>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            @enderror
                                            <small class="text-danger error-message"
                                                id="error-id_lembaga_akreditasi"></small>
                                        </div>
                                    </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#formAkreditasiProdiEdit').on('submit', function(event) {
                ...
                $.ajax({
                    url: '{{ route('akreditasi-program-studi.validationUpdate', ['id' => $akreditasi->id]) }}',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            function submitToStore(formData) {
                $.ajax({
                    url: '{{ route('akreditasi-program-studi.update', ['id' => $akreditasi->id]) }}',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
