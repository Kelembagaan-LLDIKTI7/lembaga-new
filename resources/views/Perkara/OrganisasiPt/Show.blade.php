...
@section('content')
    <div class="container-fluid my-4">
        <a href="{{ route('perguruan-tinggi.show', $perkaras->id_organization) }}"><i class="fas fa-arrow-left mb-4 me-2"></i>
            Kembali
        </a>
        <div class="row">
            <div class="col-12">
                <div class="card bordered shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <a href="{{ route('perkara-organisasipt.edit', $perkaras->id) }}" class="btn btn-primary">
