    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <h4 class="title mb-4">Role User </h4>
                                    ...
                                    <table id="dom_jq_event"
                                        ...
                                        <tbody>
                                            @foreach ($roles as $item)
                                                        ...
                                                        <td class="w-25">
                                                            <div class="d-flex align-items-center gap-2">
                                                                @can('View Role Permissions')
                                                                    <a href="{{ route('addRolePermission', $item->id) }}"
                                                ...
                                                <div class="modal fade" id="editRoleModal-{{ $item->id }}"
                                                    tabindex="-1" aria-labelledby="editRoleModalLabel-{{ $item->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="editRoleModalLabel-{{ $item->id }}">Edit Role
                                                                    User</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('roles.update', $item->id) }}"
                                                                    ...
                                                                    @method('PUT')
                                                                    <div class="mb-3">
                                                                        <label for="editRoleName-{{ $item->id }}"
                                                                            class="form-label">Nama Role</label>
                                                                        <input type="text"
                                                                            class="form-control @error('name') is-invalid @enderror"
                                                                            id="editRoleName-{{ $item->id }}"
                                                                            name="name"
                            ...
                            <form action="{{ route('roles.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="addRoleName" name="name" value="{{ old('name') }}" placeholder="Ex: Admin"
                                        required>
                                    @error('name')
