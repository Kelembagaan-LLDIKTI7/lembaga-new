                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="organisasi-kode-input-group">
                                        @for ($i = 0; $i < 6; $i++)
                                            <input type="text" maxlength="1" class="form-control organisasi-kode" id="organisasi_kode_{{ $i + 1 }}" value="{{ $perguruanTinggi->organisasi_kode[$i] ?? '' }}" required>
                                            @endfor
                                            <input type="hidden" id="organisasi_kode" name="organisasi_kode" value="{{ $perguruanTinggi->organisasi_kode }}">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
