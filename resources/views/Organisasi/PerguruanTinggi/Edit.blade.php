                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="form-text text-muted">Format yang diperbolehkan: PNG, JPG, JPEG,
                                            GIF.</small>
                                        <img id="logo-preview"
                                            src="{{ asset('storage/' . $perguruanTinggi->organisasi_logo) }}"
                                            alt="Preview Logo" style="display: block;">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control select-search" name="perubahan" id="changeType"
                                            required>
                                            <option value="Aktif"
                                                {{ $perguruanTinggi->perubahan == 'Aktif' ? 'selected' : '' }}>Pendirian
                                            </option>
                                            <option value="penyatuan"
                                                {{ $perguruanTinggi->perubahan == 'penyatuan' ? 'selected' : '' }}>
                                                Penyatuan</option>
                                            <option value="penggabungan"
                                                {{ $perguruanTinggi->perubahan == 'penggabungan' ? 'selected' : '' }}>
                                                Penggabungan</option>
                                        </select>
                                    </div>

                                    <div id="perguruan-tinggi-select"
                                        class="{{ $perguruanTinggi->perubahan == 'penyatuan' || $perguruanTinggi->perubahan == 'penggabungan' ? '' : 'hidden' }}">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="perguruan_tinggi_1" class="form-control select-search">
                                                ...
                                                @foreach ($perguruanTinggis as $perguruanTinggiOption)
                                                    <option value="{{ $perguruanTinggiOption->id }}"
                                                        {{ $perguruanTinggi->perguruan_tinggi_1 == $perguruanTinggiOption->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="perguruan_tinggi_2" class="form-control select-search">
                                                ...
                                                @foreach ($perguruanTinggis as $perguruanTinggiOption)
                                                    <option value="{{ $perguruanTinggiOption->id }}"
                                                        {{ $perguruanTinggi->perguruan_tinggi_2 == $perguruanTinggiOption->id ? 'selected' : '' }}>
                                                        {{ $perguruanTinggiOption->organisasi_nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div id="additional-perguruan-tinggi"
                                        class="{{ $perguruanTinggi->perubahan == 'penggabungan' ? '' : 'hidden' }}">
