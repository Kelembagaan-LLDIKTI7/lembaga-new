...
@section('content')
    <div class="container-fluid">
        <a href="{{ route('perkara-organisasi.show', ['id' => $perkaras->id]) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="tanggal_kejadian" id="tanggal_kejadian"
                                            ...
                                            value="{{ old('tanggal_kejadian', $perkaras->tanggal_kejadian) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="no_perkara" id="no_perkara" class="form-control"
                                            required value="{{ old('no_perkara', $perkaras->no_perkara) }}">
                                        ...
                                        <div id="existing-previews" class="preview-container">
                                            @foreach ($existingImages as $image)
                                                <div class="image-preview">
                                                    <img src="{{ asset('storage/bukti_foto/' . $image) }}"
                                                        class="img-thumbnail">
